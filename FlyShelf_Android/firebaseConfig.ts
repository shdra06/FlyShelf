...
// Audit Task 3: XOR-obfuscate ALL config values (not just apiKey + databaseURL)
// "advance-sync-default.firebaseapp.com" XOR'd with key
...
// "advance-sync-default" XOR'd with key
const PROJECT_ID_BYTES = [
  0x27, 0x08, 0x0f, 0x32, 0x06, 0x06, 0x09, 0x4b, 0x2c, 0x4b,
  0x5e, 0x51, 0x1b, 0x3b, 0x21, 0x03, 0x12, 0x1e, 0x18, 0x1b
];

// "advance-sync.firebasestorage.app" XOR'd with key
...
// "49241495533" XOR'd with key
const MESSAGING_SENDER_ID_BYTES = [
  0x72, 0x55, 0x4b, 0x67, 0x59, 0x51, 0x55, 0x53, 0x6a, 0x01,
  0x03
];

// "1:49241495533:web:a774fec697271c1b81f9e4" XOR'd with key
const APP_ID_BYTES = [
