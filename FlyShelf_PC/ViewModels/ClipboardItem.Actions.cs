                    ...
                    using (var bmp = new System.Drawing.Bitmap(path))
                    {
                        ...
                        if (result != null && !string.IsNullOrWhiteSpace(result.Text)) {
                            System.Windows.Application.Current.Dispatcher.InvokeAsync(() => {
                                // Update item type and content � do NOT auto-copy to clipboard
                                // (user clicks "Copy QR Text" button to copy explicitly)
                                ...
                                // Suppress toast for FlyShelf's own pairing QR codes
                                ...
                                AdvanceClip.Windows.ToastWindow.ShowToast($"QR Detected! Use Copy button to copy.");
                            });
                        }
                    }
