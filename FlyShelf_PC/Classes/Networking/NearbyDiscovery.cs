...
namespace FlyShelf.Classes
{
    ...
    public class NearbyDiscovery : IDisposable
    {
        ...
        public async Task BroadcastProbe()
        {
            try
            {
                ...
                var probe = new
                {
                    ...
                    hmac = ComputeProbeHmac(myDeviceId, DevicePairingManager.EnsurePairingKey())
                };
        ...
        {
            var staleIds = _discovered.Where(kv => (DateTime.UtcNow - kv.Value.DiscoveredAt).TotalSeconds > 60)
