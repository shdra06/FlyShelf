...
namespace FlyShelf.Classes
{
    ...
    {
        // PL-12: Use Lazy<T> for thread-safe singleton initialization
        private static readonly Lazy<SpawnDiagnostic> _lazy = new(() => new SpawnDiagnostic());
        public static SpawnDiagnostic Instance => _lazy.Value;
        ...
        {
            StopRecording();
            // PL-13: Suppress finalization since we've already cleaned up
