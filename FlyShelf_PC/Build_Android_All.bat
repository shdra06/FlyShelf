...
echo.
echo [4/6] Compiling Android APK natively (arm64-v8a + x86_64 Dual Arch)...
call gradlew.bat assembleRelease -PreactNativeArchitectures=arm64-v8a,x86_64
...
set "DEST_APK=%~dp0..\FlyShelf_Mobile_All.apk"
...
echo Latest APK created: FlyShelf_Mobile_All.apk
